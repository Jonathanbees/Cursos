class Salon:
    def __init__(self, idSalones, numero_salon, Piso, Capacidad_estudiantes, Iluminacion_idIluminacion, Mesas_idMesas, tablero_idtablero, Tamano3):
